...
export const Route = createFileRoute("/empresas")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Conheça as empresas do PS Business Group em setores estratégicos.",
      },
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <h1 className="font-display text-[clamp(2.5rem,6vw,5.5rem)] leading-[0.98] tracking-tight max-w-4xl text-balance">
              {t("companies.titleA")}{" "}
              <span className="italic text-gold-soft">{t("companies.titleB")}</span>.
            </h1>
      ...
      <section className="py-20 lg:py-28 bg-cream" aria-labelledby="empresas-list-heading">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h2 id="empresas-list-heading" className="sr-only">
            {t("companies.titleA")} {t("companies.titleB")}
          </h2>
