  ...
  head: () => ({
    meta: [
      { title: "Sobre — PS Business Group" },
      {
        name: "description",
        content:
          "Conheça o PS Business Group: inteligência empresarial, gestão eficiente e visão de longo prazo.",
      },
      { property: "og:title", content: "Sobre — PS Business Group" },
      {
        property: "og:description",
        content: "Inteligência empresarial, gestão eficiente e visão de longo prazo.",
      },
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-balance max-w-3xl leading-tight">
              {t("about.global.titleA")}{" "}
              <span className="italic text-gold-soft">{t("about.global.titleB")}</span>.
            </h2>
          </motion.div>
          <div className="mt-12 grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="border-l border-gold/20 pl-8 space-y-6">
              <div className="text-[10px] uppercase tracking-[0.3em] text-gold-soft/50">
                {t("tag.positioning")}
              </div>
              {[
      ...
      <section className="bg-noir text-foreground py-24 lg:py-28 text-center relative overflow-hidden">
        <div className="relative max-w-3xl mx-auto px-6 lg:px-12">
          <p className="font-display text-3xl md:text-4xl leading-snug text-balance">
            {t("about.cta.lead.a")}{" "}
            <span className="italic text-gold-soft">{t("about.cta.lead.b")}</span>
          </p>
          <Link
            to="/contato"
