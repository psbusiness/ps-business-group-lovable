...
export const Route = createFileRoute("/sobre")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sobre — PS Business Group" },
      { name: "twitter:description", content: "Inteligência empresarial, gestão eficiente e visão de longo prazo." },
    ...
    links: [
      { rel: "canonical", href: "https://psbusiness.lovable.app/sobre" },
    ],
  }),
  component: SobrePage,
});
