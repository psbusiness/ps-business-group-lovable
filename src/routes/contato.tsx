...
export const Route = createFileRoute("/contato")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Contato — PS Business Group" },
      { name: "twitter:description", content: "Entre em contato para parcerias e oportunidades de negócio." },
    ...
    links: [
      { rel: "canonical", href: "https://psbusiness.lovable.app/contato" },
    ],
  }),
