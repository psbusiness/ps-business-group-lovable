...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Grupo empresarial brasileiro reunindo empresas de excelência em logística, agronegócio, educação, esporte, capital e mais." },
      ...
      { name: "twitter:title", content: "PS Business Group — Conexões que impulsionam o futuro" },
      { name: "twitter:description", content: "Grupo empresarial brasileiro reunindo empresas de excelência em múltiplos setores estratégicos." },
    ...
    links: [
      { rel: "canonical", href: "https://psbusiness.lovable.app/" },
    ],
  }),
  component: HomePage,
});
